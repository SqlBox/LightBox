...
namespace Lightbox
{
    public partial class MainHome
    {
        ...
        {
            this.tabView1 = new Lightbox.usercontrols.TabView();
            this.tableView1 = new Lightbox.usercontrols.TableView();
            this.terminal1 = new Lightbox.ui.usercontrols.Terminal();
        ...
        {
            this.editor1 = new Lightbox.usercontrols.Editor();
