...
namespace Lightbox
{
    public partial class Home : Form
    {
        ...
        private LightboxdbDataSetTableAdapters.sql_serversTableAdapter sql_server_adapter;
        private List<LightboxdbDataSet.backup_locationsRow> backuplocations;
        ...
        public Home()
        {
            ...
            sql_server_adapter = new LightboxdbDataSetTableAdapters.sql_serversTableAdapter();
        }
        ...
        private void btEditServer_Click(object sender, EventArgs e)
        {
            ...
            {
                LightboxdbDataSet.sql_serversRow server = ((LightboxdbDataSet.sql_serversDataTable)cmbServers.DataSource).ElementAt(cmbServers.SelectedIndex);
