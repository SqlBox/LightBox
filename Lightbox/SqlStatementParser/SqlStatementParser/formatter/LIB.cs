...
namespace com.protectsoft.SqlStatementParser.formatter
{
    ...
    public static class Str
    {
        ...
        public static string Elipses(this string str, int Length, int Tail = 0)
        {
            ...
            else if (Tail == 0)
            {
                ...
                Result = str.Left(Length - 3) + "...";
            }
            else if (Tail < Length - 3)
            {
                // Insert elipses
                Result = str.Left(Length - (Tail + 3)) + "..." + str.Right(Tail);
            }
            else
            {
                // Prepend elipses
                Result = "..." + str.Right(Length - 3);
            }
            return Result;
        }
        ...
        {
            string Buffer = null;
            return str.IndexOf(Values, startIndex, comparisonType, out Buffer);
        }
        ...
        {
            string Buffer = null;
            return str.LastIndexOf(Values, startIndex, comparisonType, out Buffer);
        }
        ...
        public static string[] Split(this string str, IEnumerable<string> Values, StringComparison comparisonType = UseCase)
        {
            ...
            startIndex = str.IndexOf(Values, 0, comparisonType, out foundSeparator);
            if (startIndex > -1)
            {
                Result.Add(str.Substring(0, startIndex));

                startIndex += foundSeparator.Length;
                endIndex = str.IndexOf(Values, startIndex, comparisonType);
                while (endIndex > -1)
                {
                    Result.Add(str.Substring(startIndex, endIndex - startIndex));

                    startIndex = str.IndexOf(Values, startIndex, comparisonType, out foundSeparator);
                    startIndex += foundSeparator.Length;
                    endIndex = str.IndexOf(Values, startIndex, comparisonType);
                }
        ...
        {
            return str.Substring(new string[] { Value }, Length, comparisonType);
        }
        /// <summary>
        ...
        {
            string Value = null;
            int Index = str.IndexOf(Values, 0, comparisonType, out Value);
        ...
        {
            string Value = null;
            int Index = str.LastIndexOf(Values, str.Length, comparisonType, out Value);
        ...
        {
            return str.Mid(new string[] { startValue }, endValue != null ? new string[] { endValue } : null, comparisonType);
        }
        /// <summary>
        ...
        public static string Mid(this string str, IEnumerable<string> startValues, IEnumerable<string> endValues = null, StringComparison comparisonType = UseCase)
        {
            ...
            int startIndex = str.IndexOf(startValues, 0, comparisonType, out startValue);
            endValues = endValues ?? startValues;
            int endIndex = str.LastIndexOf(endValues, str.Length, comparisonType, out endValue);
            ...
            return str.Mid(startIndex, endIndex);
        }
    ...
    public static class Time
    {
        ...
        public static string Elapsed(ElapsedUnit unit, TimeSpan timespan)
        {
            ...
            {
                Buffer = (ulong)Math.Truncate((double)(elapsedSeconds / (60 * 60)));
    ...
    public static class KVP
    {
        public class List
        {
            ...
            internal bool GetBoolean(string value, bool? defaultValue = null)
            {
                value = value.ToLower();
